 ...
 function Home({navigation}){
  return (
    <View style={styles.container}>
        <ImageBackground source={require('./assets/icon/background.png')} style={{flex:1,justifyContent:"center",width:400}}> 
      <View style={styles.card_container}>
    <Text style={{textAlign:"center",marginTop:5,color:"#828282",fontSize:18}}>Select Our Mode</Text>
    <View style={{flexDirection:"row",flex:1,marginTop:5}}>
     ...
     <Image source={require('./assets/icon/translator.png')} style={{width:60,height:70,marginTop:0,marginLeft:15,marginTop:8,resizeMode:'contain'}} />
      ...
      <View style={{flex:1}}>
      <Text style={{marginTop:2,color:"#4F4F4F",fontSize:10, textAlign:"left",marginLeft:5}}>Lets Catch Up {'\n'} {'\n'} Translator to achieve two way communication</Text>
      </View>
      <View style={{flex:1}}>
        <View style={{width:50,height:50,backgroundColor:"#CEB7B2",borderRadius:80,marginLeft:20}}>
        <Text style={{textAlign:"center",marginTop:10,color:"#828282",fontSize:18,color:"white"}} onPress={() => navigation.navigate('Text')}>Start</Text>
        </View>
    ...
    <View style={{flexDirection:"row",flex:1}}>
     ...
     <Image source={require('./assets/icon/final_2.png')}  style={{width:60,height:70,marginTop:0,marginLeft:15,marginTop:8,resizeMode:'contain'}}  />
      ...
      <View style={{flex:1}}>
      <Text style={{marginTop:2,color:"#4F4F4F",fontSize:10, textAlign:"left",marginLeft:5}}>Hearing Test {'\n'} {'\n'} To Examine Hearing</Text>
      </View>
      <View style={{flex:1}}>
        <View style={{width:50,height:50,backgroundColor:"#CEB7B2",borderRadius:80,marginLeft:20}}>
        <Text style={{textAlign:"center",marginTop:10,color:"#828282",fontSize:18,color:"white"}}  >Start</Text>
        </View>
    ...
    <View style={{flexDirection:"row",flex:1}}>
     ...
     <Image source={require('./assets/icon/WechatIMG330.png')}  style={{width:60,height:70,marginTop:0,marginLeft:15,marginTop:8,resizeMode:'contain'}} />
      ...
      <View style={{flex:1}}>
      <Text style={{marginTop:2,color:"#4F4F4F",fontSize:10, textAlign:"left",marginLeft:5}}>Auslan Tutorial {'\n'} {'\n'} Learn Australian Sign Language</Text>
      </View>
      <View style={{flex:1}}>
        <View style={{width:50,height:50,backgroundColor:"#CEB7B2",borderRadius:80,marginLeft:20}}>
        <Text style={{textAlign:"center",marginTop:10,color:"#828282",fontSize:18,color:"white"}}>Start</Text>
      ...
      <View>
      <Text style={{marginTop:5,marginLeft:5,fontSize:20,color:"rgba(88, 79, 79, 1)",fontWeight:"bold"}}>About Hearing Loss Group</Text>
      </View>
      <EventCarousel />
 
      <Text style={{marginLeft:5,marginBottom:5,fontSize:20,color:"rgba(88, 79, 79, 1)",fontWeight:"bold"}}>Latest Event</Text>
